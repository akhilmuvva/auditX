...
import { ShieldCheck, Award, Link2, Heart } from 'lucide-react';
...
export default function BadgePage() {
  ...
  useEffect(() => {
    // Generate a beautiful, dynamic mock SVG directly for verification
    // matches the on-chain SVG representation of the token ID
    const mockSvg = `
