...
export interface AuditBadgeNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "authorizedAgent"
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, string, BigNumberish, string, boolean]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "tokenAuditData",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface AuditBadgeNFT extends BaseContract {
  connect(runner?: ContractRunner | null): AuditBadgeNFT;
  waitForDeployment(): Promise<this>;

  interface: AuditBadgeNFTInterface;
  ...
  tokenAuditData: TypedContractMethod<
    [arg0: BigNumberish],
    [
  ...
  getFunction(
    nameOrSignature: "tokenAuditData"
  ): TypedContractMethod<
    [arg0: BigNumberish],
    [
      [string, bigint, string, bigint, boolean] & {
  ...
  filters: {
    ...
    "BadgeMinted(address,uint256,string,uint8,string,bool)": TypedContractEvent<
      BadgeMintedEvent.InputTuple,
      BadgeMintedEvent.OutputTuple,
      BadgeMintedEvent.OutputObject
    >;
